...
-- TODO: http://xmonad.org/xmonad-docs/xmonad-contrib/XMonad-Doc-Extending.html is full of neat tips/ideas. Check them out.


import XMonad
-- import XMonad.Actions.UpdatePointer interesting, not sure if I like it yet
import Data.Monoid
import System.Exit
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- maximize / unmaximize
    , ((modm .|. controlMask, xK_m   ), withFocused (sendMessage . maximizeRestore))

    -- GridSelect. Kind of weird. Will leave it in to play around with for now.
...
-- myLogHook = updatePointer (Relative 0.5 0.5) interesting, not sure I like it yet.
